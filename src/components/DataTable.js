...
import logo from '../img/logo_image.jpg';
import logo2 from '../img/logo_image_2.jpg';
  ...
  const getRowHtml = row => {
    ...
    return `
      <div style="font-family: Arial, sans-serif; font-size: 12px; padding: 10px; line-height: 1.5; width: 100%;">
        <img src="${logo}" alt="Your Logo" style="width: 100px; height: 100px; object-fit: contain;">
        <img src="${logo2}" alt="Your Logo" style="width: 100px; height: 100px; object-fit: contain; margin-left: 50px;">
        ...
        <div style="font-size: 9.5px; font-weight: bold; margin-top: 5px; margin-bottom: 5px; font-family: 'Calibri';">Please be informed that we are currently experiencing a technical problem as described below:</div>
          <table style="border-collapse: collapse; width: 100%; border: 1px solid black;">
            <tr>
              ...
              <td style="text-align: center; border-left: 1px solid black; border-bottom: 1px solid black; font-family: 'Calibri';">${row.startDate ? new Date(row.startDate).toLocaleDateString('en-GB').replace(/\//g, '-') : ''}</td>
              <td style="text-align: center; border-left: 1px solid black; border-bottom: 1px solid black; font-family: 'Calibri';">${row.startTime} Jordan Time </td>
            </tr>
            <tr>
              <td style="border-bottom: 1px solid black; font-family: 'Calibri'"><strong>Region:</strong></td>
              <td colspan="2" style="text-align: center; border-left: 1px solid black; border-bottom: 1px solid black; font-family: 'Calibri'">Fiber cut in ${row.area}</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td colspan="2" style="text-align: center; border-left: 1px solid black; border-bottom: 1px solid black; font-family: 'Calibri'">${row.serviceImpact}</td>
            </tr>
            <tr>
              <td style="border-bottom: none; font-family: 'Calibri'"><strong>Informed:</strong></td>
              <td style="text-align: center; border-left: 1px solid black; border-bottom: none; font-family: 'Calibri'">${row.informedBy}</td>
              <td style="text-align: center; border-left: 1px solid black; border-bottom: none; font-family: 'Calibri'">${row.informedTime} Jordan Time </td>
            </tr>
          </table>
